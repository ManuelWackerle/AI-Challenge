...
from agent_rl import AgentRL_learn
from agent_rl_run import AgentRL_run
from agent_rl2 import AgentRL2_learn
from agent_rl2_run import AgentRL2run
from agent_rl_final import AgentRL_final
...
class Snake:
    def __init__(self, board_width, board_height, max_tics_to_starve):
        ...
        # self.agent = Agent()
        # self.agent = AgentRL_learn(board_width, board_height)
        self.agent = AgentRL2_learn(board_width, board_height)
        # self.agent = AgentRL_run(board_width, board_height, 5)
        # self.agent = AgentRL2run(board_width, board_height, 2)
        # self.agent = AgentRL_final(board_width, board_height)
        self.size = 0
